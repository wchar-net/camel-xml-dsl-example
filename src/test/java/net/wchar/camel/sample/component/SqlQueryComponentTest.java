...
public class SqlQueryComponentTest extends CamelSampleApplicationTests {
    @BeforeEach
    public void init() throws Exception {
        byte[] bytes = Files.readAllBytes(Paths.get(this.getClass().getResource("/camel_component/SqlQueryComponent.xml").toURI()));
